...
# ============================================================
# SIRF GREEN/RED BUTTONS (Fully Green/Red - Stylish Text)
# ============================================================
...
# ============================================================
# PROCESSING ANIMATION - GREEN BOXES (existing)
# ============================================================
...
# ============================================================
# ✅ NEW: PROCESSING ANIMATION - RED BOXES (Number Info ke liye)
# ============================================================
...
# ============================================================
# ✅ NEW: PROCESSING ANIMATION - PURPLE SINGLE BOX (Player Info ke liye)
# (Ek hi box aage badhta hua - purple colour)
# ============================================================
...
# ============================================================
# ✅ NEW: OWNER CREDIT CLEANUP (Number info API se owner hatake @iflexcoderr)
# ============================================================
...
def send_json_response(chat_id, data, uid_input, prefix="ban_check", clean=False):
    ...
    if clean:
        # ✅ NEW: Sirf JSON - koi text upar/niche nahi
        json_block = f"""🟢🔴 ═════════════════════════════ 🟢🔴
    ...
    try:
        ...
        try:
            ...
            if is_banned:
                ...
                # ===== ✅ NEW: BAN RECORD SAVE (TOTAL BANS ke liye) =====
                orders = load_orders()
...
# ============================================================
# ✅ NEW: NUMBER INFO - RED ANIMATION + SIRF JSON
# ============================================================
...
def process_number_info(message):
    try:
        ...
        if not number.isdigit() or len(number) < 10:
            _send_pe(message.chat.id, f"❌ Invalid number! Send only digits (10+).")
            return
...
# ============================================================
# ✅ NEW: PLAYER UID INFO - PURPLE ANIMATION + SIRF JSON
# ============================================================
...
# ============================================================
# ✅ NEW: TOTAL BANS - ADMIN (Button + Command)
# ============================================================
